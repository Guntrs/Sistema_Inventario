    ...
    <v-layout align-start>
        <v-flex>
            ...
            <v-toolbar flat color="white">
                <v-toolbar-title class="primary--text">Categorías Principal</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
                                    ...
                                    <v-card-text>
                                        <v-container grid-list-md>
                                            ...
                                            <v-flex xs12 sm12 md12>
                                                ...
                                                label="Nombre Categoria Principal"></v-text-field>
                                            </v-flex>
                                            <v-flex xs12 sm12 md12>
    ...
    export default {
        ...
        data(){
            ...
            return {
               ...
               headers: [
                    ...
                    { text: 'Categoria Principal', value: 'nombre' },
        ...
        methods:{
            ...
            listar(){
                ...
                axios.get('api/CategoriaPrincipales/Listar',configuracion).then(function(response){
            ...
            //Editar Categorias
            editItem (item) {
                this.id=  item.idCategoriaPrincipal; //valores del DB
            ...
            guardar () {
                ...
                if (this.editedIndex > -1) {
                    ...
                    axios.put('/api/CategoriaPrincipales/Actualizar',{
                        'idcategoriaprincipal':me.id,
                        'nombre': me.nombre,
                    ...
                    //Código para guardar
                    let me=this;
                    axios.post('/api/CategoriaPrincipales/Crear',{
                        'Nombre': me.nombre,
                        'Descripcion': me.descripcion
                    },configuracion).then(function(response){
                        me.close();
            ...
            activarDesactivarMostrar(accion,item){
                ...
                this.adId=item.idCategoriaPrincipal;  //valor de la BD              
                if (accion==1){
                    this.adAccion=1;
                }
                else if (accion==2){
            ...
            activar(){
                ...
                axios.put('/api/CategoriaPrincipales/Activar/'+this.adId,{},configuracion).then(function(response){
                    me.adModal=0;
                    me.adAccion=0;
                   // me.adNombre="";
                    me.adId="";
            ...
            desactivar(){
                ...
                axios.put('/api/CategoriaPrincipales/Desactivar/'+this.adId,{}, configuracion).then(function(response){
                    me.adModal=0;
                    me.adAccion=0;
                   // me.adNombre="";
                    me.adId="";
