    ...
    <v-layout align-start>
        <v-flex>
            ...
            <v-toolbar flat color="white">
                <v-toolbar-title class="primary--text">Certificado Digital</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
                    ...
                    <tr>
                        <td class="justify-center layout px-0">
                            ...
                            <!-- Columnas del DataTable (Nombre Descripcion) -->  
                                ...
                                <td>{{ props.item.archivoCertificado }}</td>                 
    ...
    export default {
        ...
        data(){
            ...
            return {
               ...
               {    text: 'Opciones', value: 'actions', sortable: false }, 
                    ...
                    { text: 'Nombre Usuario', value: 'nombreusuario', sortable: false  }, 
                    { text: 'Rol', value: 'rol', sortable: false  }, 
                    
                    { text: 'Nombre Certificado', value: 'nombre', sortable: false  }  ,
                    { text: 'Fecha Expiración', value: 'fechaespiracion', sortable: false  }, 
                    { text: 'Archivo Certificado', value: 'archivocertificado', sortable: false  },    
                    { text: 'Fecha Creacion', value: 'fechacreacion', sortable: false  }  
        ...
        methods:{
            ...
            listar(){
                ...
                axios.get('/api/CertificadoDigitales/Listar', configuracion).then(function(response){
