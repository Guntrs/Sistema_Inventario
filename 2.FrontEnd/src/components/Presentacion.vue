    ...
    <v-layout align-start>
        <v-flex>
            ...
            <v-toolbar flat color="white">
                <v-toolbar-title class="primary--text">Presentacion</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            formTitle () {
                return this.editedIndex === -1 ? 'Nueva Presentación' : 'Actualizar Presentación'
            }
        },
        ...
        methods:{
            ...
            listar(){
                ...
                axios.get('api/Presentaciones/Listar',configuracion).then(function(response){
            ...
            //Editar 
            editItem (item) {
                this.id=  item.idPresentacion; //valores del DB
            ...
            guardar () {
                ...
                if (this.editedIndex > -1) {
                    ...
                    axios.put('/api/Presentaciones/Actualizar',{
                        'idPresentacion':me.id,
                    ...
                    //Código para guardar
                    let me=this;
                    axios.post('/api/Presentaciones/Crear',{
                        'Cantidad':  parseInt(me.cantidad),
                        'Unidad': me.unidad,                       
                        'Descripcion': me.descripcion
                    },configuracion).then(function(response){
            ...
            validar(){
                ...
                if (this.cantidad.length<1 || this.cantidad.length>100){
                    this.validaMensaje.push("Favor llenar el campo cantidad ó colocar solo Números");
                }
            ...
            activarDesactivarMostrar(accion,item){
                this.adModal=1; 
                this.adNombre=item.cantidad; //valor de la BD
                this.adId=item.idPresentacion;  //valor de la BD              
                if (accion==1){
                    this.adAccion=1;
                }
                else if (accion==2){
            ...
            activar(){
                ...
                axios.put('/api/Presentaciones/Activar/'+this.adId,{},configuracion).then(function(response){
                    me.adModal=0;
                    me.adAccion=0;
            ...
            desactivar(){
                let me=this;
                axios.put('/api/Presentaciones/Desactivar/'+this.adId,{},configuracion).then(function(response){
                    me.adModal=0;
                    me.adAccion=0;
