                                ...
                                <v-container grid-list-md>
                                    <v-layout wrap>
                                        ...
                                        <v-flex xs12 sm12 md12 >
                                            <v-text-field 
                                            v-model="nombre" 
                                            label="Nombre del Articulo"></v-text-field>
                                        </v-flex>
                                        ...
                                        <v-flex >
                                            ...
                                            max-rows="5"                                             
                                            v-model="descripcion" 
                                            placeholder="Descripciòn Del Articulo" 
                                            style="width:390px"
                                        ...
                                        <v-flex xs6 sm6 md6>        
                                            ...
                                            label="Cantidad de Medidad "> </v-text-field>                                       
                                        </v-flex>
        ...
        data(){
            return {
               ...
               headers: [
                    ...
                    { text: 'Categoría del Articulo', value: 'categoria' },
                ...
                unidades:['mg.','gr.','kg.', 'lb.', 'onz.','ml','L.',
                          'und.','mg/und.','gr/und.','ml/und.','onz/und.','hojas'],
                cantidad:0.0,
