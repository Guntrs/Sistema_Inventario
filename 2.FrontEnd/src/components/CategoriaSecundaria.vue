    ...
    <v-layout align-start>
        <v-flex>
            ...
            <v-toolbar flat color="white">
                <v-toolbar-title class="primary--text">Categoria Secundaria</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
                            ...
                            <v-card>
                                    ...
                                    <v-card-text>
                                        <v-container grid-list-md>
                                            <v-layout wrap>
                                                <v-flex xs6 sm6 md6>
                                                    <v-select v-model="idprincipal"
                                                        :items="categoriaprincipales" label="Categoria Principal">
                                                     </v-select>
                                                </v-flex>

                                            <v-flex xs12 sm12 md12>
                                                <v-text-field v-model="nombre" 
                                                label="Nombre Categoria Secundaria"></v-text-field>
                                            </v-flex>
                                            <v-flex xs12 sm12 md12>
    ...
    export default {
        ...
        data(){
            ...
            return {
               ...
               headers: [
                    ...
                    { text: 'Categoria Principal', value: 'categoriaprincipal' },                   
                    { text: 'Categoria Secundaria', value: 'nombre' },
        ...
        methods:{
            ...
            listar(){
                ...
                axios.get('api/CategoriaSecundarias/Listar',configuracion).then(function(response){
            ...
            select5(){
                ...
                var categoriasArray=[];
                axios.get('api/CategoriaPrincipales/Select',configuracion).then(function(response){
                    categoriasArray=response.data;
                    categoriasArray.map(function(x){
                        me.categoriaprincipales.push({text: x.nombre, value:x.idCategoriaPrincipal},); //valores del Select BD
                    });
                }).catch(function(error){
                    console.log(error);
               });
            ...
            //Editar Categorias
            editItem (item) {
                this.id=  item.idCategoriaSecundaria; //valores del DB

                this.idprincipal=item.idCategoriaPrincipal;
            ...
            guardar () {
                ...
                if (this.editedIndex > -1) {
                    ...
                    axios.put('/api/CategoriaSecundarias/Actualizar',{

                        'idcategoriasecundaria':me.id,

                        'idcategoriaprincipal': me.idprincipal,
                        'nombre': me.nombre,
                    ...
                    //Código para guardar
                    let me=this;
                    axios.post('/api/CategoriaSecundarias/Crear',{
                        'IdCategoriaPrincipal':me.idprincipal,
                        'Nombre': me.nombre,
                        'Descripcion': me.descripcion
                    },configuracion).then(function(response){
            ...
            activarDesactivarMostrar(accion,item){
                ...
                this.adId=item.idCategoriaSecundaria;  //valor de la BD              
                if (accion==1){
                    this.adAccion=1;
                }
                else if (accion==2){
            ...
            activar(){
                ...
                axios.put('/api/CategoriaSecundarias/Activar/'+this.adId,{},configuracion).then(function(response){
                    me.adModal=0;
                    me.adAccion=0;
                   // me.adNombre="";
                    me.adId="";
            ...
            desactivar(){
                ...
                axios.put('/api/CategoriaSecundarias/Desactivar/'+this.adId,{}, configuracion).then(function(response){
                    me.adModal=0;
                    me.adAccion=0;
                   // me.adNombre="";
                    me.adId="";
